...
public partial class Form1 : Form
{
    ...
    private void button_KeyDown(object? sender, KeyEventArgs e)
    {
        if (e.Control && e.KeyCode == Keys.N)
            ...
            buttonCopy_Click(sender, e);    // Chama o método para copiar

        else if (e.Control && e.KeyCode == Keys.V)
            buttonPaste_Click(sender, e);   // Chama o método para colar

        else if (e.Control && e.KeyCode == Keys.X)
            buttonCut_Click(sender, e);     // Chama o método para cortar

        else if (e.KeyCode == Keys.F7)
            buttonCompile_Click(sender, e); // Chama o método para compilar

        else if (e.KeyCode == Keys.F1)
            buttonTeam_Click(sender, e);    // Chama o método para mostrar a equipe
    }
